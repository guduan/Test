...
if appMode
    ...
    girderAxisMove(1:nGird,repmat([0 0 geo.bfwz],nGird,1),[quadDelta'*1e3 repmat(geo.quadz,nGird,1)]);
    ...
    % Adjust RFBPM offsets
    posBPM1=girderAxisFind(1:nGird,geo.bpmz,geo.quadz);
    dBPM=(posBPM1(:,1:2)-posBPM0(:,1:2))';
    pvList=model_nameConvert(static.bpmList(uBPM),'EPICS');
