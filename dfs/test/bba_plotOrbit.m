function bba_plotOrbit(static, xMeas, xMeasStd, xMeasF, en, varargin)
%BBA_PLOTORBIT
...
% Plot Orbit.
zBPM=static.zBPM;zQuad=static.zQuad;
...
legX=cellstr(num2str([en(:) std(xM(:,:,1),0,1)'*1e6],'En = %6.2f GeV, \\sigma_x = %6.1f \\mum'));
legY=cellstr(num2str([en(:) std(xM(:,:,2),0,1)'*1e6],'En = %6.2f GeV, \\sigma_y = %6.1f \\mum'));
