...
%MODEL_BEAMLINEL3
% BEAMLINE = MODEL_BEAMLINEL3() Returns beam line description list for L2.
...
%  KQ30801 =  0.418743774352;
  ...
  KQ30201 =  0.431061251508; % New BSY optics
  KQ30301 = -0.469798912489;
  KQ30401 =  0.389442551401;
  KQ30501 =  -0.582099319705;
  KQ30601 =  0.32792543523;
  KQ30615 =  0;
  KQ30701 =  -0.368249399517;
  KQ30715 =  0;
  KQ30801 =  0.38340496772;
...
% ------------------------------------------------------------------------------
  ...
  LI25  =[LI25beg,ZLIN09, ...
                ...
                K25_3,D256a,PH03,D256b,BL22,D256e,OTR22,D256c, ...
...
% ------------------------------------------------------------------------------
  ...
  LI27  =[LI27beg,ZLIN11, ...
                ...
                K27_6,DAQ5A,DAQ5B,DAQ5C,WS27644,DAQ5X,Q27701, ...
                BPM27701,Q27701,DAQ2, ...
...
% ------------------------------------------------------------------------------
  ...
  LI28  =[LI28beg,ZLIN12, ...
                K28_1,DAQ5D,XC29092,DAQ5E,YC29092,DAQ5F,WS28144,DAQ6,Q28201, ...
                BPM28201,Q28201,DAQ2, ...
                K28_2,DAQ1,Q28301,BPM28301,Q28301,DAQ2, ...
                K28_3,DAQ1,Q28401,BPM28401,Q28401,DAQ2, ...
                K28_4,DAQ5G,XC29095,DAQ5H,YC29095,DAQ5I,WS28444,DAQ6,Q28501, ...
                BPM28501,Q28501,DAQ2, ...
                K28_5,DAQ1,Q28601,BPM28601,Q28601,DAQ2, ...
                K28_6,DAQ1,Q28701,BPM28701,Q28701,DAQ2, ...
                K28_7,DAQ5J,DAQ5K,DAQ5L,WS28744,DAQ5Y,Q28801, ...
                BPM28801,Q28801,DAQ2, ...
...
% ------------------------------------------------------------------------------
  ...
  LI29  =[LI29beg,ZLIN13, ...
                ...
                DAQ4C,C30096,DAQ4D,PK299,DAQ4E, ...
                LI29end];
...
% ------------------------------------------------------------------------------
  ...
  K30_8 =[K30_8a1,XC30802,K30_8a2,YC30803,K30_8a3,K30_8b,K30_8c1,XC30900, ...
                K30_8c2,YC30900,K30_8c3];
