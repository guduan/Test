...
%PARSE_OPTS
%  OPTS = PARSE_OPTS(OPTS, OPTSDEF) copies fields in OPTS into OPTSDEF and
%  returns OPTSDEF. OPTS can also be a parameter/value list which gets
%  passed to STRUCT() to generate OPTS structure. Cell arrays in argument
%  list are put into cells as neccessary to permit scalar OPTS structure.
