...
%MODEL_NAMECONVERT
%  [NAME, STAT, ISSLC] = MODEL_NAMECONVERT(NAME, OUTTYPE) converts EPICS, SLC, or
%  MAD names into the desired type.
%
% Input arguments:
%    NAME:    The EPICS, SLC, or MAD device name(s) (e.g., 'BPMS:IN20:221').
%             NAME can be a char array, or cellstr, or array of cellstr of any
%             shape if multiple names are converted
%    OUTTYPE: 'EPICS', 'MAD', or 'SLC', default is 'EPICS'
%    MICRO:   Searches for primaries NAME in micro list MICRO
%
% Output arguments:
%    NAME:  The converted name (e.g., 'BPM2') or array of converted names.
%           The data type and array shape of the input argument NAME is
...
% Author: Henrik Loos, Paul Emma, William Colocho, SLAC
...
secList={'LI00' 'LI01' 'LI02' 'LI03' 'LI04' 'LI05' 'LI06' 'LI07' 'LI08' ...
         ...
         'LI18' 'LI19' 'LR20' 'IN20' 'LI20' 'LI21' 'LI22' 'LI23' 'LI24' ...
         'LI25' 'LI26' 'LI27' 'LI28' 'LI29' 'LI30' 'BSY0' 'BSY1' 'LTU0' ...
         'LTU1' 'UND1' 'DMP1' 'DR01' 'DR03' 'DR13' 'FEE1' 'NEH1' 'FEH1' ...
         'SYS0'};

secList2=[secList {'CA01' 'CA11' 'AB01'}]; % Includes non LCLS stuff for isSLC test
...
if numel(name) == numel(nameIn), name=reshape(name,size(nameIn));end
